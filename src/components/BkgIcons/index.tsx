...
import { style, style2, small2, small3, medium, medium2, large } from '../../utils/constants'
...
const BkgIcons = () => {
  ...
  const { iconTransformX, iconTransformY, handleMousePosition } = useIconTransform(container)
